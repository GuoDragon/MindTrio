...
**更新日期**：2025-11-20
**目标版本**：mindnlp 0.5.1 + mindspore 2.7.0 / 2.7.1
...
**实例规格**（推荐）：
- **计算资源**：Ascend: 1*ascend-snt9b1
- **CPU/内存**：ARM: 24核 192GB
- **磁盘空间**：50GB或以上

**内置环境**：
- MindSpore: 2.7.1（镜像内置）
- CANN: 8.2rc1（镜像内置）
- Python: 3.10

### 版本兼容性说明

新镜像使用 **MindSpore 2.7.1**，相比之前的2.7.0有小版本升级：
- ✅ **向后兼容**：2.7.1与mindnlp 0.5.1完全兼容
- ✅ **更稳定**：CANN从alpha2升级到rc1，更加稳定
- ✅ **无需降级**：可以直接使用镜像内置的MindSpore 2.7.1

如果在使用过程中遇到任何版本冲突，可以通过以下命令降级：
```bash
